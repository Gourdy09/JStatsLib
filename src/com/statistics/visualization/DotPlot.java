...
public class DotPlot extends JPanel {
   ...
   // Use GraphUtil.calcValueToX if needed, but here we provide a simple conversion.
   ...
   public void paintComponent(Graphics g) {
      ...
      // Statistical markers remain as before.
      ...
      // Draw count axis on the left remains as before.
